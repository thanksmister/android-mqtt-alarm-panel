...
public class LogActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if(id == FEED_LOADER_ID) {
            return new CursorLoader(LogActivity.this, SyncProvider.FEED_DATA_TABLE_URI, 
