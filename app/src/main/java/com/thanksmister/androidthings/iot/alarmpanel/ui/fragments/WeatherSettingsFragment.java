...
import com.thanksmister.androidthings.iot.alarmpanel.utils.LocationUtils;

import timber.log.Timber;

import static com.thanksmister.androidthings.iot.alarmpanel.R.xml.preferences_weather;
...
public class WeatherSettingsFragment extends PreferenceFragmentCompat 
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Timber.d("configuration.showWeatherModule: " + configuration.showWeatherModule());
