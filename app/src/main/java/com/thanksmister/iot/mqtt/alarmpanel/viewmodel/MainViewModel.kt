...
constructor(application: Application, private val messageDataSource: MessageDao, private val sunSource: SunDao, private val configuration: Configuration) : AndroidViewModel(application) {
