...
class DashboardsActivity : BaseSettingsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (supportActionBar != null) {
            ...
            supportActionBar?.title = "Dashboards"
        }

        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction().replace(R.id.contentFrame, DashboardsFragment.newInstance(), DASHBOARDS_FRAGMENT).commit()
        }
    ...
    companion object {
        const val DASHBOARDS_FRAGMENT = "com.thanksmister.fragment.DASHBOARDS_FRAGMENT"
        fun createStartIntent(context: Context): Intent {
            return Intent(context, DashboardsActivity::class.java)
        }
    }
}